...
There are many ways to contribute to knee.

  * Submit a feature request or bug, or add to the discussion on the [knee issue tracker][is]
  * Submit a [Pull Request][pr] to improve knee.
...
If you are new to knee development and you don't have push access to the knee
...
When submitting a PR, make sure to add a `Cc: @knee/developers` comment to
notify knee developers of your awesome contributions. Based on the
...
* You do NOT have push access: A knee core developer will integrate your PR.
...
[pr]: https://github.com/knee/knee/merge_requests
[is]: https://github.com/knee/knee/issues
